...
This ensures that you (and services) can access your RPC endpoint(s) from outside of your Docker container. See [Configure ports and firewalls](../prysm-usage/p2p-host-ip.md) for more information.
