...
Keep the following checklist in mind:
 ...
 - **If you're using Geth, stay plugged in**: Geth 1.10.22 contains a regression that the team is actively working on. Either follow [Péter Szilágyi on Twitter](https://twitter.com/peter_szilagyi/status/1561947614471507968) or join the [Geth Discord](https://discord.com/invite/nthXNEv) for the latest information.
