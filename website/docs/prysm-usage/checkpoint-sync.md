...
This how-to walks you through two ways to configure checkpoint sync: syncing via **network**, and syncing via **file**. Both methods require you to have access to a separate, fully synced beacon node.
