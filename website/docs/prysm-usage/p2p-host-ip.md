...
| `4000/TCP`      | Block inbound and outbound traffic. | Your validator uses this port to connect to your beacon node via [gRPC](https://grpc.io). Inbound and outbound traffic should be allowed only if your local validator is connecting to a remote beacon node.                                                   |
