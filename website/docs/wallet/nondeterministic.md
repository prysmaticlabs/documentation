...
You can import existing EIP-2335 keystore files (such as those generated by the [eth2.0-deposit-cli](https://github.com/ethereum/eth2.0-deposit-cli)) into Prysm. Importing your own keys is a highly recommended security best practice because it allows you to create a mnemonic (and derived keys) using the software that you trust most. This allows you to keep your sensitive mnemonic isolated away from your validator machine.
