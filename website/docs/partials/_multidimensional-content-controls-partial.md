...
<Tabs className="with-label os-tabgroup" groupId="os" defaultValue="others" values={[
...
<Tabs className="with-label network-tabgroup" groupId="network" defaultValue="mainnet" values={[
...
<Tabs className="with-label hidden-in-docker-guide el-tabgroup" groupId="execution-clients" defaultValue="geth" values={[
...
<Tabs className="with-label hidden-in-jwt-guide hidden-in-docker-guide enbn-tabgroup" groupId="protocol" defaultValue="jwt" values={[
