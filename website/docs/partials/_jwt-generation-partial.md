...
To authenticate the HTTP connection between beacon node / execution node, a [JWT token](https://jwt.io/) is needed. There are several ways to generate this JWT token:
