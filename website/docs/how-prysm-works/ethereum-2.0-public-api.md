...
| ethereum_slashing | [Slasher](https://github.com/prysmaticlabs/prysm/blob/master/proto/slashing/slashing.proto) | -------- | This API provides access to slashing protection data a validator might use. |
