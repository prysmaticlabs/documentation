...
For a standard API that all Ethereum beacon nodes implement, see [here](./ethereum-public-api). Over the next few quarters, we plan on deprecating this API and replacing it with the standard API.
:::
