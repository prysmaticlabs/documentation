...
<strong id='footnote-1'>1</strong>. It may happen that the block is from a previous epoch (if the assigned proposer failed to propose a block in the first slot, for example).   <br />
