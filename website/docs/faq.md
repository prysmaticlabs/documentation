...
2. Check your network connectivity. You can improve this by following our tips [here](/prysm/docs/prysm-usage/p2p-host-ip) which can help you find better peers, improve attestation effectiveness, and more.
...
1. Your network connectivity has problems. You can check how to improve it with some of our tips [here](/prysm/docs/prysm-usage/p2p-host-ip).
...
3. A bug in our software that can affect your p2p connectivity. It is known that certain versions have issues with peers on operating systems such as Windows, so you could try [downgrading](/prysm/docs/prysm-usage/staying-up-to-date) to see if your issue is resolved. If this is the case, talk to our team on [Discord](https://discord.gg/prysmaticlabs) letting us know you had this issue.
...
Upgrading Prysm is done differently depending on your operating system and installation method. We prepared comprehensive instructions here in our docs portal on [upgrading and downgrading Prysm](/prysm/docs/prysm-usage/staying-up-to-date).
...
We prepared comprehensive instructions here in our docs portal on [upgrading and downgrading Prysm](/prysm/docs/prysm-usage/staying-up-to-date).
...
Yes, we currently support arm 64-bit architectures such as the raspberry pi 4 and they go out as part of our pre-compiled binary releases [here](https://github.com/prysmaticlabs/prysm/releases). Our documentation portal has instructions on how to run the entire installation process [here](/prysm/docs/install/install-with-script). However, we recommend using more powerful hardware in mainnet conditions. 
