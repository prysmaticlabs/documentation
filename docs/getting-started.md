...
#### [Update and downgrade Prysm](/monitoring-alerts-metrics/staying-up-to-date.md)
Learn how to **keep Prysm updated**, how to downgrade Prysm, and how to use release candidates.

---

#### [Sync from a checkpoint](/configure-prysm/sync-from-checkpoint.md)
...
#### [Back up & restore database](/backup-and-migration/backup-and-restore-db.md)
...
#### [Import & export slashing protection history](/backup-and-migration/slashing-protection-history.md)
...
#### [Switch to a new client](/backup-and-migration/switch-to-a-new-client.md)
...
#### [Create a Prysm wallet](/manage-wallet/create-prysm-wallet.md)
...
#### [Use Prysm's Web UI](/monitoring-alerts-metrics/prysm-web-ui.md)
:::warning Deprecated
...
#### [Secure gRPC connections](/managing-connections/secure-grpc.md)
Learn how to create and configure TLS certificates that enable secure gRPC connections to your Beacon node.

---

#### [Configure ports and firewalls for improved network connectivity](/managing-connections/configure-ports-firewalls-for-p2p.md)
...
#### [Slashing](/learn/concepts/slashing.md)
...
#### [Golang resources](/learn/tools/about-golang.md)

---

#### [About Bazel](/learn/tools/about-bazel.md)
...
#### [Beacon node](/learn/dev-concepts/beacon-node.md)
...
#### [End-to-end tests](/learn/dev-concepts/end-to-end.md)
...
#### [Ethereum learning resources](/learn/external-reading.md)

---

#### [Testnet postmortems](/misc/testnet_postmortems.md)
