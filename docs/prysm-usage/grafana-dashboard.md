...
- [dashboard designed for small amount of validator keys](./small_amount_validators.json)
- [dashboard designed for more than 10 validator keys](.big_amount_validators.json).
