    ...
    <div className='checklist'>
        ...
        <div className='task'>
            ...
            <div className='guidance-container'>
                ...
                <p>Ensure that you're using the <a href='https://github.com/OffchainLabs/prysm/releases'>latest stable Prysm release</a>. Check Prysm's version by issuing the following command: <code>prysm.sh beacon-chain --version</code> (Linux) <code>prysm.bat beacon-chain --version</code> (Windows).</p>
            </div>
        </div>
        <div className='task'>
        ...
        <div className='task'>
            ...
            <div className='guidance-container'>
                ...
                <p>Prysm will output an error if you attempt to provide an invalid Ethereum wallet address as a fee recipient address. You'll see warnings if a fee recipient address hasn't been provided. See [Configure Fee Recipient](/configure-prysm/configure-fee-recipient.md) for more information.</p>
            </div>
        </div>
        <div className='task'>
            ...
            <div className='guidance-container'>
                ...
                <Tabs className="tabgroup-with-label" groupId="network" defaultValue="mainnet" values={[
                    ...
                    <TabItem value="hoodi">Paste your validator's public key (available in your <code>deposit_data-*.json</code> file) into a <a href='https://hoodi.beaconcha.in/'>blockchain explorer like beaconcha.in</a> to check the status of your validator.</TabItem>
        ...
        <div className='task hidden-in-status-guide'>
            ...
            <div className='guidance-container'>
                ...
                <p>Issue still not resolved? <a href='#generate-troubleshooting-report'>Generate a troubleshooting report below</a>. Head over to <a href='https://discord.gg/prysm'>Discord</a> and paste your report for additional troubleshooting assistance.</p>
            </div>
        </div>
    </div>
</div>
