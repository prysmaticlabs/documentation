...
Your fee recipient wallet address can also be set through the <a href='/prysm-usage/web-interface'>Web UI</a> dashboard. The Web UI uses the <a href='/apis/keymanager-api'>Key Manager APIs</a> to set the fee recipient.
...
<strong id="footnote-1">1.</strong> See <a href='/learn/concepts/nodes-and-networks'>Nodes and Networks</a> for a quick refresher on the fundamentals of Ethereum nodes. <br /><br />
