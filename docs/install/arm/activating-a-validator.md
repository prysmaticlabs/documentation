...
Open a terminal window. Depending on your installation method, issue the appropriate command from the examples below to start the beacon node.

#### Starting the beacon node with Docker
...
Open a second terminal window. Depending on your installation method, issue the appropriate command from the examples below to start the validator.
