---
id: bazel
title: Installing Prysm on Windows with Bazel
...
Prysm can be installed on Windows using our build tool, Bazel. This page includes instructions for performing this method.
